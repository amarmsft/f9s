...
func AccessorFor(f Factory, gvr client.GVR) (Accessor, error) {
	m := Accessors{
		...
		client.NewGVR("apis.clusterfleet.io/v1alpha1/applications"): &Application{},
		client.NewGVR("manifests"):                                  &Manifest{},
		client.NewGVR("applicationStatus"):                          &ApplicationStatus{},
...
func loadK9s(m ResourceMetas) {
	...
	m[client.NewGVR("manifests")] = metav1.APIResource{
		Name:         "manifests",
		Kind:         "manifests",
	...
	m[client.NewGVR("applicationStatus")] = metav1.APIResource{
		Name:         "applicationStatus",
		Kind:         "applicationStatus",
		SingularName: "applicationStatus",
		Verbs:        []string{},
		Categories:   []string{"k9s"},
	}
}
